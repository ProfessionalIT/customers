...
var username = "100510105502247833110"; // username for your picasa web album account
var album = "PERSIANAS GUINARTH"; // name of album (Folder name)
var show_all_albums = 0; // 0 = only use album specified in album variable. 1 = show photos from all picasa albums
var phwidth = 640; // pictureholder width
var phheight = 480; // pictureholder height
// pictureholder DIV also has the class 'pictureholder' so you can add CSS border etc.
var photosize = 640; // width to show photos at
...
var caption_height = 10; // How many pixels high for caption box if on
