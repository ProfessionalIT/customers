...
class inserir():
    ...
    def POST(self, param):
        ...
        if frm.validates():
            ...
            if param=='Produto':
                display_message='Inseriu o registro %s com sucesso !' % frm.d.codigo
            else:
                display_message='Inseriu o registro %s com sucesso !' % frm.d.nome
...
class editar():
    ...
    def POST(self, param, record_id):
        ...
        if param=='Produto':
            display_message='Alterou o registro %s com sucesso !' % frm.d.codigo
        else:
            display_message='Alterou o registro %s com sucesso !' % frm.d.nome
        web.setcookie('display_message', display_message)
