...
def contato (action, method, form):
    ...
    extend_([u'    <span>(51) 3364-9607 - (51) 3365-1166 - (51) 3364-9600</span>\n'])
...
def base (render_vars, content):
    ...
    extend_([u'                <span class="span_details_phone">(51) 3364-9600</span>\n'])
    extend_([u'                <span class="span_details_phone">(51) 3364-9620</span>\n'])
    extend_([u'            </div>\n'])
    ...
    extend_([u'        </div>\n'])
    extend_([u'    </div>\n'])
    extend_([u'    <div id="footer"><p>Enveloprint 2012 - Fones: (51) 3365-1166 - (51) 3364-9600 | CNPJ: 001.887.292/0001-99</p></div>\n'])
    extend_([u'    <script type="text/javascript">\n'])
