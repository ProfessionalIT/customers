...
************************************************************************************************************/
    ...
    function startSlide(e)
    {
        ...
        var id = this.id;
        this.getElementsByTagName('IMG')[0].src = '/static/image-slideshow/images/' + this.id + '_over.gif';
    ...
    {
        var id = this.id;
        this.getElementsByTagName('IMG')[0].src = '/static/image-slideshow/images/' + this.id + '.gif';
        slideSpeed=0;
    }
