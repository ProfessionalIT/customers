...
function getEventByMonthYear(par_month, par_year){
    ...
    if (par_month==0){
        ...
        var arrEventos = new Array('03/12/2014;E;Apresentação de Ballet - 19:00 hs.',
                                   ...
                                   '18/12/2013;R;Recesso Fim de Ano.',
                                   '19/12/2013;R;Recesso Fim de Ano.',
                                   '20/12/2013;R;Recesso Fim de Ano.',
                                   '23/12/2013;R;Recesso Fim de Ano.',
                                   '24/12/2013;R;Recesso Fim de Ano.',
                                   '26/12/2013;R;Recesso Fim de Ano.',
                                   '27/12/2013;R;Recesso Fim de Ano.',
                                   '30/12/2013;R;Recesso Fim de Ano.',
                                   '31/12/2013;R;Recesso Fim de Ano.',
                                   '25/12/2013;N;Feriado de Natal.');
        return arrEventos;
    } else {
        var arrEventos = new Array();
        return arrEventos;
